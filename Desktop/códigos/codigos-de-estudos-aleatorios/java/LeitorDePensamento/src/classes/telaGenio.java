...
public class telaGenio extends javax.swing.JFrame {
    ...
    public telaGenio() {
        initComponents();
        lblFrase.setText("<html>Fale um número entre <strong> 1 e 5<strong> <html>");
    }
    ...
    private void initComponents() {
        ...
        lblFrase.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
        ...
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 240, 60));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/geen.png"))); // NOI18N
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 260, -1, -1));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        String f2 = "<html>Pensei no valor <html>" +valor+"<html>";
